...
author: baoxiang
date: 2019.8.2
use lr model to chekc performance in test file
'''
...
def get_test_data(test_file, feature_num_file):
    ...
    Args:
        ...
        feature_num_file: the total number of features
    Return:
...
def get_auc(predict_list, test_label):
    ...
    sorted_total_list = sorted(total_list, key = lambda x:x[1])
    neg_num = 0
    pos_num = 0
    count = 1
    total_pos_index = 0
...
def run_check(test_file, lr_coef_file, lr_model_file, feature_num_file):
    ...
    Args:
        ...
        feature_num_file: file record the total number of features
    """
